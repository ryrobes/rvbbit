...
Using cell ref like :my-results1/field-name.0 do NOT need to be wrapped in brackets, but they should be wrapped in [:str x] if you want to display it inside a re-com or hiccup block.
