...
(defn create-attribute-sample
  ...
  (try
    (let [;key-hash sample-table-name-str (cstr/replace key-hash #"-" "_") ;; hashes are often
          ;negative. No bueno.
          field-types (cstr/join ""
                                 (for [[k v] (first rowset)]
                                   (let [type (cond (string? v) "varchar" ;"text"
                                                    (integer? v) "integer"
                                                    (float? v) "float"
                                                    (cstr/includes? (str (type v)) "DateTime")
                                                      "timestamp"
  ...
  ("
           ...
           ")   ;"))
    (catch Exception e
      (ut/pp [:error-creating-ddl-for-sample-based-on-rowset sample-table-name-str
              :error (str e)
              :rowset rowset]))))
  ...
  {:top-20-outliers
     {:data
        [{:ask-mutates {"Highlight these in your source query?"
                          {[:panels :block-984 :queries :OFFENSE-CODE-GROUP-drag-40 :style-rules
                            [:* :higlight-1584150552]]
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "713.1985540610642" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":calc-used"]
                 [:box :child "[:percentiles [0.01 0.99]]" :style {:font-weight 400}]]]]]
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":DISTRICT"] [:box :child "\"B2\"" :style {:font-weight 400}]]]]]
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query--15841505520-agg/*.clicked
                              [:*all= :kit-query--15841505520-agg/*.clicked [:DISTRICT]]
                              [:and [:= :DISTRICT "B2"]]]}]
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "1099.883942741233" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":YEAR"] [:box :child "2016" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query-16401701570-agg/*.clicked
                              [:*all= :kit-query-16401701570-agg/*.clicked [:YEAR]]
                              [:and [:= :YEAR 2016]]]}]
         ...
         {:ask-mutates {"Highlight these in your source query?"
          ...
          :content
            [[:v-box
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":YEAR"] [:box :child "2015" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query--18381605500-agg/*.clicked
                              [:*all= :kit-query--18381605500-agg/*.clicked [:YEAR]]
                              [:and [:= :YEAR 2015]]]}]
          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:YEAR]}
          :name
            ...
            [[:v-box
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query-4557610560-agg/*.clicked
                              [:*all= :kit-query-4557610560-agg/*.clicked [:DISTRICT]]
                              [:and [:= :DISTRICT nil]]]}]
          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:DISTRICT]}
          :name
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "203.27949813964352" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
             ...
             {:_h            4
              ...
              :style-rules   {[:* :highlight-group] {:logic [:and [:= :DISTRICT "C11"]
                                                             [:= :YEAR 2016]]
                                                     :style {:background-color "#008b8b66"
                                                             :border "1px solid #00000000"}}}}
             "All rows in this group:"
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "224.17681203807757" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":MONTH"] [:box :child "8" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query-5221562210-agg/*.clicked
                              [:*all= :kit-query-5221562210-agg/*.clicked [:MONTH]]
                              [:and [:= :MONTH 8]]]}]
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "19.093579791187643" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":STREET"]
                 [:box :child "\"WASHINGTON ST\"" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :from          [:query/OFFENSE-CODE-GROUP-drag-40]
              :select        [:*]
              :where         [:*if :kit-query-18989472110-agg/*.clicked
                              [:*all= :kit-query-18989472110-agg/*.clicked [:STREET]]
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "221.0048037122471" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":HOUR"] [:box :child "4" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query-11056468470-agg/*.clicked
                              [:*all= :kit-query-11056468470-agg/*.clicked [:HOUR]]
                              [:and [:= :HOUR 4]]]}]
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "80.21461447267573" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
             ...
             [:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":YEAR"] [:box :child "2018" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query--7639220590-agg/*.clicked
                              [:*all= :kit-query--7639220590-agg/*.clicked [:MONTH :YEAR]]
                              [:and [:= :MONTH 9] [:= :YEAR 2018]]]}]
         ...
         {:ask-mutates {"Highlight these in your source query?"
          ...
          :content
            [[:v-box
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":HOUR"] [:box :child "18" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query--11042651260-agg/*.clicked
                              [:*all= :kit-query--11042651260-agg/*.clicked [:HOUR]]
                              [:and [:= :HOUR 18]]]}]
          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:HOUR]}
          :name
         ...
         {:ask-mutates {"Highlight these in your source query?"
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "164.0140416773727" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
             ...
             {:_h            4
              ...
              :style-rules   {[:* :highlight-group] {:logic [:and [:= :DAY_OF_WEEK "0001-01-07"]
                                                             [:= :YEAR 2016]]
                                                     :style {:background-color "#008b8b66"
                                                             :border "1px solid #00000000"}}}}
             "All rows in this group:"
          ...
          :step-mutates {}}
         {:ask-mutates
            {"Highlight these in your source query?"
               {[:panels :block-984 :queries :OFFENSE-CODE-GROUP-drag-40 :style-rules
                 [:* :higlight-1094684804]]
          ...
          :content
            [[:v-box
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":STREET"] [:box :child "nil" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :from          [:query/OFFENSE-CODE-GROUP-drag-40]
              :select        [:*]
              :where         [:*if :kit-query--10946848040-agg/*.clicked
                              [:*all= :kit-query--10946848040-agg/*.clicked [:STREET]]
                              [:and [:= :STREET nil]]]}
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":STREET"]
                 [:box :child "\"BLUE HILL AVE\"" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :from          [:query/OFFENSE-CODE-GROUP-drag-40]
              :select        [:*]
              :where         [:*if :kit-query--10946848041-agg/*.clicked
                              [:*all= :kit-query--10946848041-agg/*.clicked [:STREET]]
          ...
          :content
            [[:v-box
             ...
             {:_h            8
              ...
              :from          [:query/OFFENSE-CODE-GROUP-drag-40]
              :select        [:*]
              :where         [:*if :kit-query--6830423270-agg/*.clicked
                              [:*all= :kit-query--6830423270-agg/*.clicked [:STREET]]
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "154.30158648515814" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
         ...
         {:ask-mutates {"Highlight these in your source query?"
          ...
          :content
            [[:v-box
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":MONTH"] [:box :child "2" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :where         [:*if :kit-query--17263516290-agg/*.clicked
                              [:*all= :kit-query--17263516290-agg/*.clicked [:MONTH]]
                              [:and [:= :MONTH 2]]]}]
          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:MONTH]}
          :name
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "103.99576059838641" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
          ...
          :content
            [[:v-box
             ...
             {:_h            4
              ...
              :order-by      [[3 :desc]]
              :select        [:DAY_OF_WEEK :YEAR [[:count 1] :rows]]
              :style-rules   {[:* :highlight-group] {:logic [:and [:= :DAY_OF_WEEK "0001-01-03"]
                                                             [:= :YEAR 2015]]
                                                     :style {:background-color "#008b8b66"
                                                             :border "1px solid #00000000"}}}}
             "All rows in this group:"
          ...
          :content
            [[:v-box
             ...
             [:v-box :size "auto" :width "490px" :style {:font-size "16px"} :children
              [[:h-box :size "auto" :justify :between :children
                [[:box :child ":STREET"]
                 [:box :child "\"COMMONWEALTH AVE\"" :style {:font-weight 400}]]]]]
             "as a wider aggregate:"
             {:_h            4
             ...
             {:_h            8
              ...
              :from          [:query/OFFENSE-CODE-GROUP-drag-40]
              :select        [:*]
              :where         [:*if :kit-query--11145542300-agg/*.clicked
                              [:*all= :kit-query--11145542300-agg/*.clicked [:STREET]]
          ...
          :content
            [[:v-box
              ...
              [[:h-box :size "auto" :justify :between :children
               ...
               [:h-box :size "auto" :justify :between :children
                [[:box :child ":standard-deviation"]
                 [:box :child "11.367280405615126" :style {:font-weight 400}]]]
               [:h-box :size "auto" :justify :between :children
   ...
   ;;        :dupoes {:data [{:ask-mutates {"Highlight these in your source query?" {[:panels
   ;;        :block-984 :queries :OFFENSE-CODE-GROUP-drag-40 :style-rules [:*
   ;;        :higlight-1584150552]] {:logic [:and
   ;;        [:= :DISTRICT "B2"]],
   ;;                                                                                                                                                                   :style
   ;;                                                                                                                                                                   {:background-color
   ;;                                                                                                                                                                   "#008b8b66",
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--15841505520-agg, :connection-id
   ;;                     "boston-crime", :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--15841505520-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--15841505520-agg/*.clicked [:*all=
   ;;                     :kit-query--15841505520-agg/*.clicked [:DISTRICT]] [:and [:=
   ;;                     :DISTRICT "B2"]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-16401701570-agg, :connection-id "boston-crime",
   ;;                     :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-16401701570-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query-16401701570-agg/*.clicked [:*all=
   ;;                     :kit-query-16401701570-agg/*.clicked [:YEAR]] [:and [:= :YEAR
   ;;                     2016]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--18381605500-agg, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:YEAR], :order-by [[2
   ;;                     :desc]], :select [:YEAR [[:count 1] :rows]], :style-rules {[:*
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--18381605500-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--18381605500-agg/*.clicked [:*all=
   ;;                     :kit-query--18381605500-agg/*.clicked [:YEAR]] [:and [:= :YEAR
   ;;                     2015]]]}],
   ;;          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:YEAR]}, :name "When grouping
   ;;          by year and aggregating by :rows there are values that are higher than the mean
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-4557610560-agg, :connection-id "boston-crime",
   ;;                     :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:DISTRICT], :order-by
   ;;                     [[2
   ;;                     :desc]], :select [:DISTRICT [[:count 1] :rows]], :style-rules {[:*
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-4557610560-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--1359119830-agg, :connection-id "boston-crime",
   ;;                     :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:DISTRICT :YEAR],
   ;;                     :order-by [[3 :desc]], :select [:DISTRICT :YEAR [[:count 1] :rows]],
   ;;                     :style-rules
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--1359119830-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--1359119830-agg/*.clicked [:*all=
   ;;                     :kit-query--1359119830-agg/*.clicked [:DISTRICT :YEAR]] [:and [:=
   ;;                     :DISTRICT "C11"] [:= :YEAR 2016]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-5221562210-agg, :connection-id "boston-crime",
   ;;                     :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-5221562210-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-18989472110-agg, :connection-id "boston-crime",
   ;;                     :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-18989472110-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query-18989472110-agg/*.clicked [:*all=
   ;;                     :kit-query-18989472110-agg/*.clicked [:STREET]] [:and [:= :STREET
   ;;                     "WASHINGTON
   ;;                     ST"]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-11056468470-agg, :connection-id "boston-crime",
   ;;                     :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-11056468470-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query-11056468470-agg/*.clicked [:*all=
   ;;                     :kit-query-11056468470-agg/*.clicked [:HOUR]] [:and [:= :HOUR 4]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--7639220590-agg, :connection-id "boston-crime",
   ;;                     :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--7639220590-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--7639220590-agg/*.clicked [:*all=
   ;;                     :kit-query--7639220590-agg/*.clicked [:MONTH :YEAR]] [:and [:= :MONTH
   ;;                     9] [:= :YEAR 2018]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--11042651260-agg, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:HOUR], :order-by [[2
   ;;                     :desc]], :select [:HOUR [[:count 1] :rows]], :style-rules {[:*
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--11042651260-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--11042651260-agg/*.clicked [:*all=
   ;;                     :kit-query--11042651260-agg/*.clicked [:HOUR]] [:and [:= :HOUR
   ;;                     18]]]}],
   ;;          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:HOUR]}, :name "When grouping
   ;;          by hour and aggregating by :rows there are values that are higher than the mean
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-6852976080-agg, :connection-id "boston-crime",
   ;;                     :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:DISTRICT :YEAR],
   ;;                     :order-by [[3 :desc]], :select [:DISTRICT :YEAR [[:count 1] :rows]],
   ;;                     :style-rules
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-6852976080-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-20911511790-agg, :connection-id "boston-crime",
   ;;                     :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-20911511790-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query-20911511790-agg/*.clicked [:*all=
   ;;                     :kit-query-20911511790-agg/*.clicked [:DAY_OF_WEEK :YEAR]] [:and [:=
   ;;                     :DAY_OF_WEEK "0001-01-07"] [:= :YEAR 2016]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--10946848040-agg, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:STREET], :order-by
   ;;                     [[2
   ;;                     :desc]], :select [:STREET [[:count 1] :rows]], :style-rules {[:*
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--10946848040-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*],
   ;;                     :where [:*if :kit-query--10946848040-agg/*.clicked [:*all=
   ;;                     :kit-query--10946848040-agg/*.clicked [:STREET]] [:and [:= :STREET
   ;;                     nil]]]}
   ;;                    [:v-box :size "auto" :width "490px" :style {:font-size "16px"}
   ;;                    :children
   ;;                    [[:h-box :size "auto" :justify :between :children [[:box :child
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--10946848041-agg, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:STREET], :order-by
   ;;                     [[2
   ;;                     :desc]], :select [:STREET [[:count 1] :rows]], :style-rules {[:*
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--10946848041-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--10946848041-agg/*.clicked [:*all=
   ;;                     :kit-query--10946848041-agg/*.clicked [:STREET]] [:and [:= :STREET
   ;;                     "BLUE HILL
   ;;                     AVE"]]]}],
   ;;          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:STREET]}, :name "When grouping
   ;;          by street and aggregating by :rows there are values that are higher than the
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--6830423270-agg, :connection-id "boston-crime",
   ;;                     :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:STREET], :order-by
   ;;                     [[2
   ;;                     :desc]], :select [:STREET [[:count 1] :rows]], :style-rules {[:*
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--6830423270-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--6830423270-agg/*.clicked [:*all=
   ;;                     :kit-query--6830423270-agg/*.clicked [:STREET]] [:and [:= :STREET
   ;;                     "DORCHESTER
   ;;                     AVE"]]]}],
   ;;          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:STREET]}, :name "When grouping
   ;;          by street and aggregating by :rows there are values that are higher than the
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--15567526000-agg, :connection-id
   ;;                     "boston-crime", :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--15567526000-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--15567526000-agg/*.clicked [:*all=
   ;;                     :kit-query--15567526000-agg/*.clicked [:DAY_OF_WEEK]] [:and [:=
   ;;                     :DAY_OF_WEEK "0001-01-06"]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--17263516290-agg, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:MONTH], :order-by
   ;;                     [[2
   ;;                     :desc]], :select [:MONTH [[:count 1] :rows]], :style-rules {[:*
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--17263516290-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--17263516290-agg/*.clicked [:*all=
   ;;                     :kit-query--17263516290-agg/*.clicked [:MONTH]] [:and [:= :MONTH
   ;;                     2]]]}],
   ;;          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:MONTH]}, :name "When grouping
   ;;          by month and aggregating by :rows there are values that are higher than the mean
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-12960974150-agg, :connection-id "boston-crime",
   ;;                     :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:DAY_OF_WEEK
   ;;                     :DISTRICT],
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-12960974150-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query-12960974150-agg/*.clicked [:*all=
   ;;                     :kit-query-12960974150-agg/*.clicked [:DAY_OF_WEEK :DISTRICT]] [:and
   ;;                     [:= :DAY_OF_WEEK "0001-01-07"] [:= :DISTRICT "C11"]]]}],
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-5126744750-agg, :connection-id "boston-crime",
   ;;                     :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:DAY_OF_WEEK :YEAR],
   ;;                     :order-by
   ;;                     [[3 :desc]], :select [:DAY_OF_WEEK :YEAR [[:count 1] :rows]],
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-5126744750-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query--11145542300-agg, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :group-by [:STREET], :order-by
   ;;                     [[2
   ;;                     :desc]], :select [:STREET [[:count 1] :rows]], :style-rules {[:*
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query--11145542300-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query--11145542300-agg/*.clicked [:*all=
   ;;                     :kit-query--11145542300-agg/*.clicked [:STREET]] [:and [:= :STREET
   ;;                     "COMMONWEALTH AVE"]]]}],
   ;;          :highlight-columns {:OFFENSE-CODE-GROUP-drag-40 [:STREET]}, :name "When grouping
   ;;          by street and aggregating by :rows there are values that are higher than the
   ...
   ;;                    "as a wider aggregate:"
   ;;                    {:_h 4,
   ;;                     :_query-id :kit-query-14349881320-agg, :connection-id "boston-crime",
   ;;                     :from
   ...
   ;;                    "All rows in this group:"
   ;;                    {:_h 8,
   ;;                     :_query-id :kit-query-14349881320-detail, :connection-id
   ;;                     "boston-crime", :from
   ;;                     [:query/OFFENSE-CODE-GROUP-drag-40], :select [:*], :where [:*if
   ;;                     :kit-query-14349881320-agg/*.clicked [:*all=
   ;;                     :kit-query-14349881320-agg/*.clicked [:DISTRICT :STREET]] [:and [:=
   ;;                     :DISTRICT "C11"] [:= :STREET "DORCHESTER AVE"]]]}],
   ...
   ;;  :description "Top 20 Outlier by Severity", :mutates {}, :options {:actions? false,
   ;;  :pages? true, :search? false},
   ;;  :parameters {}}
  })
