...
(defn pool-create
  [jdbc-body name]
  (delay (let [base  {;:jdbc-url "jdbc:sqlite:db/system.db" :minimum-idle 10 ;; min iodle
                      :idle-timeout 600000
...
(def system-db
  {:datasource
     @(pool-create
        {;;:jdbc-url
         :jdbc-url
           "jdbc:sqlite:file:./db/system.db?cache=shared&journal_mode=WAL&mode=memory&transaction_mode=IMMEDIATE" ; "jdbc:sqlite:db/system.db"
